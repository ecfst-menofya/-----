...
document.addEventListener('DOMContentLoaded', () => {
    ...
    document.querySelectorAll('textarea.table-cell-input').forEach(ta => {
            ...
            try {
                ...
                const canvas = await window.html2canvas(ambassadorCard, {
                    ...
                    onclone: (clonedDoc) => {
                        ...
                        // استبدال كل textarea بـ div ليعرض النص كله بدون قص
                        clonedDoc.querySelectorAll('textarea.table-cell-input').forEach(ta => {
                            const div = clonedDoc.createElement('div');
                            div.className = 'export-cell';
                            div.textContent = ta.value;
                            // نسخ direction إذا كان ltr (مدة التدريب)
